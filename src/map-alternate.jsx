...
const MapAlternate = () => {
  ...
  React.useEffect(() => {
    ...
    mapRef.current.on("load", () => {
      ...
      // var bbox = [-125.00165, 24.396308, -66.93457, 49.384358];
      // const bbox = [-179, 18, -66, 71];
      // var bboxCalifornia = [-124.566244, 32.528832, -114.131211, 42.009518];
      // mapRef.current.setMaxBounds(bboxCalifornia);
